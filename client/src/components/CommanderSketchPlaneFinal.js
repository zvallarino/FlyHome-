...
function CommanderSketchPlaneFinal({commanderSketchRef, commanderSketchFinal ,commanderSketchPlaneFinal, commanderSketchPlaneRef}) {
  ...
  useEffect(()=>{
    ...
    if(commanderSketchPlaneRef.current){
