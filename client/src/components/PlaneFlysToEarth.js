...
function PlaneFlysToEarth({planeLeaveAnimation, planeAnimationRef}) {


    console.log(planeAnimationRef.current)
  ...
  bossA.src = 'https://i.imgur.com/XZZfSAt.png';
...
export default PlaneFlysToEarth;